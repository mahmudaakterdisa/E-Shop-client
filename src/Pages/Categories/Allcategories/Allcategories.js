        ...
        <div>
            <div className='categories-Banner flex justify-center items-center'>
                <div className='text-center font-bold' style={{ color: '#F1F6F9' }}>
                    <p className='text-9xl'>{categories_name}</p>
                    <p className='text-4xl'>Zone</p>
                </div>
            </div>


            <div className='available-categories w-4/6 mx-auto'>
                <div className='grid grid-cols-1 w-full sm:grid-cols-2 pl-40 py-20 gap-y-10'>
                    {
